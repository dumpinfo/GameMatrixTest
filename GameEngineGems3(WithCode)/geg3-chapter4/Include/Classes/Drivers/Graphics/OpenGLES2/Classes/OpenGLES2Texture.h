...
namespace Leadwerks
{
	class OpenGLES2Texture : public Texture
	{
		public:
...
//		virtual void GetPixels(const char* pixels, const int miplevel=0, const int framenumber=0, const int x=0, const int y=0, const int width=0, const int height=0);
		virtual void WritePixel(const int x, const int y, const char r, const char g, const char b, const char a, const int miplevel=0, const int framenumber=0);
		virtual void WritePixel(const int x, const int y, const unsigned short luminosity, const int miplevel=0, const int framenumber=0);
		virtual Asset* Copy();
		virtual void Reset();
