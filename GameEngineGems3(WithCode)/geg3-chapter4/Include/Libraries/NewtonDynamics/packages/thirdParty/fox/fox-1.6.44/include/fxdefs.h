...
enum FXSelType {
  ...
  SEL_JOYSTICK,						   /// Joystick input event
  SEL_LAST
  };
...
#if 0
extern void * __cdecl malloc(_In_ size_t _Size);
extern void   __cdecl free(_Inout_opt_ void * _Memory);
extern void * __cdecl realloc(_In_opt_ void * _Memory, _In_ size_t _NewSize);
extern void * __cdecl calloc(_In_ size_t _NumOfElements, _In_ size_t _SizeOfElements);
#endif
}
