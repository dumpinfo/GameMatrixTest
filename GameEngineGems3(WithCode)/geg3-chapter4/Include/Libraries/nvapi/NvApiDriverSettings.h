...
enum ESetting {
    ...
    TOTAL_DWORD_SETTING_NUM = 76,
    TOTAL_WSTRING_SETTING_NUM = 4,
    TOTAL_SETTING_NUM = 80,
...
enum EValues_PS_FRAMERATE_LIMITER {
    ...
    PS_FRAMERATE_LIMITER_MASK                            = 0xff7800ff,
    PS_FRAMERATE_LIMITER_NUM_VALUES = 18,
...
enum EValues_SHIM_RENDERING_OPTIONS {
    ...
    SHIM_RENDERING_OPTIONS_NUM_VALUES = 22,
