...
void main(void)
{
	...
	tcoord.x += sin(currenttime*speed*aspect+tcoord.x/wavesize)*amplitude,0.0,1.0;
	tcoord.y += cos(currenttime*speed+tcoord.y/wavesize)*amplitude; 
